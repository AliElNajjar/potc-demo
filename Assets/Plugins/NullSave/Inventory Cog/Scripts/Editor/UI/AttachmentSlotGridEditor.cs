...
{
    [CustomEditor(typeof(AttachmentSlotGrid))]
    public class AttachmentSlotGridEditor : TOCKEditorV2
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            MainContainerBegin("Attachment Slot Grid", "Icons/item-grid");

            if (SectionToggle(DisplayFlags.Behaviour, "Behaviour", BehaviourIcon))
            {
                SimpleProperty("slotUIPrefab");
                SimpleProperty("attachmentItemList");
            }

            if (SectionToggle(DisplayFlags.UI, "UI", UIIcon))
            {
                SimpleProperty("gridSize");
            ...
            if (SectionToggle(DisplayFlags.Events, "Events", EventsIcon))
            {
                ...
                SimpleProperty("onAttachmentsAvail");
                SimpleProperty("onNoAttachmentsAvail");
                SimpleProperty("onHasAttachments");
                SimpleProperty("onHasNoAttachments");
            }
