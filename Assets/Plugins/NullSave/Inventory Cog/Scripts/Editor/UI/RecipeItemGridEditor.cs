...
{
    [CustomEditor(typeof(RecipeItemGrid))]
    public class RecipeItemGridEditor : TOCKEditorV2
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            MainContainerBegin("Recipe Item Grid", "Icons/item-grid");
