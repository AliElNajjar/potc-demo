...
{
    [CustomEditor(typeof(InventoryItemGrid))]
    public class InventoryItemGridEditor : TOCKEditorV2
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            MainContainerBegin("Item Grid", "Icons/item-grid");
            ...
            if (SectionToggle(DisplayFlags.UI, "UI", UIIcon))
            {
                ...
                if((GridPageMode)SimpleInt("pageMode") == GridPageMode.AllAvailable)
                {
                    SimpleProperty("alwaysFillPage");
                }
